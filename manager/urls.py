...
urlpatterns = [
    ...
    path('hello/', hello),
    path("add_like_to_comment/<int:id_book>/<int:id_comment>/",
         AddLike2Comment.as_view(),
         name="add-like-to-comment"),
    path("add_like_to_comment/<int:id_book>/<int:id_comment>/<str:location>/",
         AddLike2Comment.as_view(),
         name="add-like-to-comment-location"),
    path("add_rate_to_book/<int:id>/<int:rate>/",
