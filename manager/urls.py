...
from manager.views import hello, MyPage, AddLike2Comment, AddRate2Book, BookDetail, AddBook, AddComment
...
urlpatterns = [
    ...
    path("add-comment-location/<str:slug>/<str:location>/", AddComment.as_view(), name="add-comment-location"),
